 ...
 * Adapted from NXP's datasheet,
 * and Adafruit's PN532 library.
...
// Command APDU
#define C_APDU_CLA   						(0x0)
#define C_APDU_INS   						(0x1) // instruction
#define C_APDU_P1    						(0x2) // parameter 1
#define C_APDU_P2    						(0x3) // parameter 2
